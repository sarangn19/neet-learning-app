...
const leaderboardData = [
  { rank: 1, name: 'Science Pro', avatar: '🧑‍🔬', xp: 2450, streak: 45 },
  { rank: 2, name: 'Bio Whiz', avatar: '🔬', xp: 2180, streak: 32 },
  { rank: 3, name: 'Chem Master', avatar: '🧪', xp: 1950, streak: 28 },
  { rank: 4, name: 'Physics Fan', avatar: '⚛️', xp: 1720, streak: 21 },
  { rank: 5, name: 'Learner', avatar: '📚', xp: 1500, streak: 15 },
];
...
export default function Leaderboard() {
  ...
  const allUsers = [...leaderboardData, { rank: 0, name, avatar, xp, streak: 0 }]
    .sort((a, b) => b.xp - a.xp)
    .map((u, i) => ({ ...u, rank: i + 1 }));
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6 pb-24">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Diamond League</h1>
